    ...
    <div style="display: flex; align-items: center; gap: 15px;">
        <form action="dashboard.php" method="GET" style="display: flex; gap: 10px;">
            <input type="text" name="search" placeholder="Search movies..." 
                   ...
                   style="padding: 10px; border-radius: 20px; border: none; width: 250px;">
            <button type="submit" class="logout">Search</button>
        </form>

        <button class="logout" onclick="window.location.href='profile.php'">My Profile</button>
